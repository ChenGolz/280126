// Build: 2026-02-01-v13
try { window.KBWG_PRODUCTS_BUILD = '2026-02-01-v2'; console.info('[KBWG] KBWG_PRODUCTS_BUILD ' + window.KBWG_PRODUCTS_BUILD); } catch(e) {}
...
(function () {
  ...
  var productsPath = resolveFromBase('data/products.json?v=2026-02-01-v6');
  var intlBrandsPath = resolveFromBase('data/intl-brands.json?v=2026-02-01-v6');
  ...
  Promise.allSettled([fetchJson(productsPath), fetchJson(intlBrandsPath)])
    ...
    .finally(function () {
      ...
      loadScript(resolveFromBase('assets/js/products.js?v=2026-02-01-v13')).catch(function (e) {
